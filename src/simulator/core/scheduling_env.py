...
class SchedulingEnv(gym.Env):
    ...
    def __init__(self, app_definitions_path, trace_dir, branching_trace_path,
                 job_sched_algo, action_group_size, logging_level,
                 ...
                 pipeline_accuracy_file=None, dynamic_rerouting=None,
                 no_early_dropping=None, last_stage_early_drop=None):
        ...
        self.simulator = Simulator(app_definitions_path=app_definitions_path,
                                   trace_path=trace_dir, mode='debugging',
        ...
        self.n_executors = self.simulator.get_num_executors()
