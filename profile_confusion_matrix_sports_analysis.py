...
data_dir = 'profiling/output'
profiling_dir = 'profiling/accuracy/sports_analysis'
...
for obj_det_model in obj_det_models:
    obj_det_gt_df = pd.read_csv(os.path.join(data_dir, f'{obj_det_ground_truth}_sports_preprocessed_30fps.csv'))
    obj_det_model_df = pd.read_csv(os.path.join(data_dir, f'{obj_det_model}_sports_preprocessed_30fps.csv'))
    ...
    # print(f'obj_det_cmatrix_df: {obj_det_cmatrix_df}')
